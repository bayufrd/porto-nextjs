...
export const metadata: Metadata = {
  title: "Dastrevas",
  description:
    "Dastrevas is a proficient Software Engineer and Full Stack Developer from Indonesia, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
